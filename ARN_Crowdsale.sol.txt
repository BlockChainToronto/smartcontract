 ...
 */
contract AryanNavaToken is ERC20Mintable {

  string public constant name = "AryanNava Token";
...
contract AryanNavaCrowdsale is CappedCrowdsale, RefundableCrowdsale, MintedCrowdsale {


    uint256 _openingTime = now;
    uint256 _closingTime = now + 15 minutes;
    uint256 _rate = 100;
    address _wallet =msg.sender;
    //0x796c35f4fb6270daf566043ef85c97e7f5184d65;

    //0xE927ef2b363b567F6F7A80557dF32ed699ddB61F;
    uint256 _cap=200000000000000000000;
    ERC20Mintable _token=new AryanNavaToken();
    uint256 _goal=10000000000000000000;

    function AryanNavaCrowdsale() public
